...
-- Insere os 4 alunos que já faziam parte da base original.
INSERT INTO alunos (nome,turma_id) VALUES
('Ana',1),('Bruno',1),('Carlos',2),('Daniela',2);

-- Insere mais 10 alunos nas duas turmas que já existem.
INSERT INTO alunos (nome,turma_id) VALUES
('Beatriz',1),('Caio',1),('Eduarda',1),('Felipe',2),('Gabriela',2),
('Henrique',2),('Isabela',2),('João',2),('Larissa',2),('Mateus',2);

-- Cria uma carteirinha para cada um dos 14 alunos.
-- numero e aluno_id são UNIQUE, garantindo a relação de uma carteirinha por aluno.
...
-- Insere as 3 disciplinas originais e mais 3 disciplinas novas.
-- O total final fica em 6 disciplinas.
INSERT INTO disciplinas (nome) VALUES
('Banco de Dados'),('Programação Web'),('Redes'),
('Engenharia de Software'),('Programação Orientada a Objetos'),('Sistemas Operacionais');

-- Cria as matrículas dos alunos nas disciplinas.
-- Cada par aluno_id + disciplina_id representa uma matrícula.
